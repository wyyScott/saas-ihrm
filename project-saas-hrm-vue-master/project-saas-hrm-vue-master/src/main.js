...
import departments from '@/module-departments/' // 部门管理模块
import employees from '@/module-employees/' // 员工管理模块
import settings from '@/module-settings/' // 角色管理模块
import permissions from '@/module-permissions/' // 权限管理模块
